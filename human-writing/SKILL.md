---
name: human-writing
description: 用于中文写作中的选题孵化、观点碰撞、资料研究、长文创作和改稿，适合热点、工具、口播、零散观点、知乎回答、论坛长帖、公众号文章、博客、评论、产品分析、行业解读、教程、评测、个人叙事、人物故事、小说、对白、口播稿和演讲稿。现实内容需要核验事实、引语、数据与用户亲历，虚构内容需要保持人物、场景和因果成立；成稿需要自然中文韵律，并清除翻案腔、商业黑话和模型惯用表达。
---
...
只维护用户明确确认、且能从用户材料或其公开文章中验证的作者方法。不得临时编造作者经历、人格和长期偏好。

## 先判断当前阶段

先看用户现在想做什么，再决定加载哪些规则。不要把每次输入都当成一份等待成稿的写作需求。

| 输入状态 | 默认阶段 |
| --- | --- |
| 大致方向、口播、零散观点、要求头脑风暴或反驳 | 观点孵化 |
| 明确要求查资料 | 研究，不擅自写作 |
| 主旨和材料清楚，明确要求直接写 | 写作 |
| 提供现成原稿并要求修改 | 修改 |
| 同时要求想清楚并写出来 | 先孵化，除非明确要求一轮完成 |
| 多轮对话中的简短回应 | 延续当前阶段 |

观点孵化读取 `references/idea-battle.md`，不执行长文材料门槛。用户选择收束后，按照该文件的研究流程核验材料、形成具体选题。具体选题确认后才进入写作。

研究发现原判断站不住时，回到观点孵化。写作发现材料撑不起选题时，回到研究。用户明确要求跳过讨论时，进入他指定的阶段。

## 进入写作后先看作品靠什么站住

这一步只在具体选题已经确认、准备搭框架或动笔时执行。它先于提纲和正文，用户要求的字数不能跳过它。观点孵化阶段不运行这一关。
...
- 大致方向、口播、零散观点、头脑风暴、反驳和选题孵化，读取 `references/idea-battle.md`。这一阶段不要提前加载成稿审查规则。
- 新写或大幅重写现实类文章时，读取 `references/author-methods.md`。热点工具、行业趋势、个人观点、产品分析、实测复盘和人物访谈都从里面选择对应路径。纯虚构任务不读取，除非用户明确要求借用其中某种叙述方法。
...
4. `references/author-methods.md` 中与当前非虚构任务对应的观察和判断路径。
...
作者方法不等于作者画像。不能根据旧文临时补出用户的履历、工作现场、情绪、人格或长期偏好，也不能把别人的案例改写成用户亲历。
